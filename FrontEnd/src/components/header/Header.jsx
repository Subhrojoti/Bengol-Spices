    ...
    <header class="flex border-b border-gray-300 py-3 px-4 sm:px-10 bg-white min-h-[65px] tracking-wide relative z-50">
      <div class="flex flex-wrap items-center gap-4 max-w-screen-xl mx-auto w-full">
        ...
        >
          ...
          >
            <svg
              ...
              class="w-3.5 h-3.5 fill-slate-900"
          ...
          <ul class="lg:flex lg:ml-14 lg:gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
            ...
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
              <a
                ...
                class="font-medium lg:hover:text-blue-700 text-blue-700 block text-[15px]"
              >
                Home
              </a>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
              <a
                href="javascript:void(0)"
                class="font-medium lg:hover:text-blue-700 text-slate-900 block text-[15px]"
              >
                Team
              </a>
            </li>
        ...
        <div class="flex gap-4 ml-auto">
          <div class="flex max-w-xs w-full bg-gray-100 px-4 py-2.5 outline outline-transparent border border-gray-200 focus-within:border-slate-900 focus-within:bg-transparent transition-all">
            <input
              type="text"
